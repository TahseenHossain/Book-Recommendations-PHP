...
<body>
    <form action="HomeVal.php" method="POST">
        ...
        <div class="split right">
            <table>
                <tr> <td> <button type="submit" name="choice" class="button1" value="choice">Based On Choice</button> </td> 
                     ...
                     <td>    </td><td>   </td><td>   </td><td>   </td><td>   </td><td>   </td><td>   </td>
                     <td>    </td><td>   </td><td>   </td><td>   </td><td>   </td><td>   </td><td>   </td>
                     <td> <button type="submit" name="recent" class="button1" value="rhis">Based On Reading History</button> </td>
                </tr>
            </table>
            <table>
            <?php
                ...
                $sql = "SELECT title, author, story FROM storyinfo where genre= SELECT genre COUNT(genre)as title from readh GROUP BY genre ORDER BY COUNT(*) DESC LIMIT 1";              
