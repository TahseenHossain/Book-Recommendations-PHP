    ...
    <form action="HomeVal.php" method="POST">
        <div class="common">
            ...
            <table>
                ...
                <tr><input type="book" name="book" class="input-box" placeholder="Search Book"></tr>
        ...
        <div class="split right">
            ...
            <?php
                ...
                $sql = "SELECT * FROM storyinfo where title= '$title' ";
            ...
            ?>
                ...
                <table>
                    <tr> <button type="submit" name="wish1" class="button2" value="wist">Add To Wish List</button> </tr>
                    <tr> <button type="submit" name="now1" class="button2" value="now">Add To Reading Right Now</button> </tr>
                    <tr> <button type="submit" name="history1" class="button2" value="history">Add To Reading History</button> </tr>
                </table>
            <hr>
        </div>
        </div>
